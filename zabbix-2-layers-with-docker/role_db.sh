...
SQL4="create user '${ZABBIX_USER}'@'${ZABBIX_SRV_IP}' identified with mysql_native_password by '${ZABBIX_PASS}';"
SQL5="grant all privileges on ${ZABBIX_BD}.* to '${ZABBIX_USER}'@'${ZABBIX_SRV_IP}';"
SQL6="UPDATE mysql.user SET Super_Priv='Y' WHERE user='${ZABBIX_USER}' AND host='${ZABBIX_SRV_IP}';"
SQL7="flush privileges;"
mysql -h localhost -u root -p${MYSQL_ROOT_PASSWORD} -e "${SQL1}${SQL2}${SQL3}${SQL4}${SQL5}${SQL6}${SQL7}"
