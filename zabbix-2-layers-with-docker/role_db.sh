...
SQL4="create user '${ZABBIX_USER}'@'${DOCKER_SRV_IP}' identified with mysql_native_password by '${ZABBIX_PASS}';"
SQL5="grant all privileges on ${ZABBIX_DB}.* to '${ZABBIX_USER}'@'${DOCKER_SRV_IP}';"
SQL6="UPDATE mysql.user SET Super_Priv='Y' WHERE user='${ZABBIX_USER}' AND host='${DOCKER_SRV_IP}';"
